const indoorPlants = [];
const outdoorPlants = [];
let welcome = prompt("Welcome to your Plant Tracker! Current Indoor Plants List:" + indoorPlants  + "     " + "Current Outdoor Plants List:" + outdoorPlants  + "     " +  "Are you ready to begin? (type: yes or no)").toLowerCase();
